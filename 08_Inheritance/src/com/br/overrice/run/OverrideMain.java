...
public class OverrideMain {
	...
	public static void main(String[] args) {
		...
		Book bk1 = new Book("수학의 정석","홍성대",100);
		...
		// 1. toString()
		// 오버라이딩 전 : Object클래스의 toString()호출 : return 풀클래스명 + @ + 주소값16진수
		// 오버라이딩 후 : Book클래스의 toString()호출 : return 해당 객체의 멤버변수 값들;
		...
		//레퍼런스끼리 동등비교 시 equals메소드 사용
		System.out.println(bk3.equals(bk4)); // false 오버라이딩 전, 후는 true
		
		// 오버라이딩전 : Object클래스의 equals메소드 실행 => return 두 객체간의 주소값은 비교(==);
		// 오버라이딩후 : Book클래스에 equals메소드 실행 => return 두 객체간의 모든 필드값들 비교;
		
		// 동일 객체 : equals의 결과 true이고 + 각 객체의 hashCode결과값이 일치
