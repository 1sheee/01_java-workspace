...
public class AnimalMain {
	...
	public static void main(String[] args) {
		...
		for(int i =0; i<arr.length;i++) {
			System.out.println(arr[i].bark()); // 동적바인딩
	 ...
	 * 
	 * 
	 * 클래스에서 클래스 상속 : 클래스 extends 클래스 (단일) 화살표 "실선"
	 * 클래스에서 인터페이스 상속 : 글래스 implements 인터페이스, 인터페이스 (다중상속) "점선"
	 * 인터페이스에서 인터페이스 상속 : 인터페이스 extends 인터페이스, 인터페이스 (다중상속)
	 * 
	 * 				|	추상클래스         |            인터페이스
	 * =======================================================================================
	 * 상속 갯수 	|	단일상속		   |			다중상속 
	 * 키워드		|   extends			   | 			implements
	 * 추상메소드   |   추상메소드 0개이상 | 	모든메소드가 추상 메소드
	 * 표현법/객수  |  명시적 abstract 기술| 	묵시적으로 abstract (생략가능)
	 * 일반메소드  	| 		o			   |                  x
