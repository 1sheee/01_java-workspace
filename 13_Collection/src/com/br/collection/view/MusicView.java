...
public class MusicView {//s
	...
	public void mainMenu() {
		...
		while(true) {
			...
			case 7: searchTitlecount(); break;
			
			case 0 : System.out.println("프로그램을 종료합니다. 이용해주셔서 감사합니다.");return;
			
			default : System.out.println("메뉴를 잘 못 선택하셨습니다. 다시 선택해주세요.");
	...
	public void inputMusic() {
		...
		System.out.println("성공적으로 추가됐습니다.");
	...
	public void selectMusic() {
		...
		// list가 텅 비어있을 경우 => "현재 존재하는 곡이 없습니다."
		if(list.isEmpty()) {
			System.out.println("현재 존재하는 곡이 없습니다.");
		}else {
			// list가 비어있지 않을 경우 => 존재하는 Music 객체 전체 출력
	...
	public void searchMusicTitle() {
		...
		System.out.print("가수를 검색하세요 : ");
		String Artist = sc.nextLine();
		
		List<String> sh = mc.hsh(Artist);
